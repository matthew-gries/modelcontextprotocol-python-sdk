...
class FunctionResource(Resource):
    ...
    The function can optionally request a Context object by adding a parameter
    with the Context type annotation, similar to tools.
    """
    ...
    async def read(
        ...
        Args:
            context: Optional context to inject into the function if it accepts one.
        """
        try:
